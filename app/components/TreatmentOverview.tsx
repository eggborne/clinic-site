    ...
    <section className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-7xl mx-auto px-6">
        <div className="shadow rounded overflow-hidden flex flex-col gap-6">
          ...
          />
          <div className="p-6 bg-offblack text-white h-full flex gap-6 justify-between">
            ...
            <div className='flex flex-col justify-end gap-12 flex-1'>
              <div className="flex-1">
                <h3 className="font-heading text-2xl">GET HELP FROM OUR TEAM</h3>
                <p className="font-main text-small text-transwhite">
        ...
        <div className="shadow rounded overflow-hidden flex flex-col gap-6">
          ...
          <div className="p-6 bg-offblack text-white h-full flex gap-6 justify-between">
            ...
            <div className='flex flex-col justify-end gap-12 flex-1'>
              <div className="flex-1">
                <h3 className="font-heading text-2xl">HOW DO I CONTROL...</h3>
                <p className="font-main text-small text-transwhite">
